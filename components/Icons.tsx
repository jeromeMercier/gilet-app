...
<Svg  width="100%" height="100%" viewBox="0 0 179.553 181.169">
  <G id="GDOR" transform="translate(-176.54 -312.071)">
    ...
    <Path id="Tracé_5" fill="black" data-name="Tracé 5" d="M43.822,106.343a39.209,39.209,0,0,0-9.756,6.134c-3.346,3.065-7.806-1.117-2.789-3.905,4.462-2.507,8.643-3.344,12.545-2.228Z" transform="translate(326.18 449.071) rotate(114)" fill-rule="evenodd"/>
